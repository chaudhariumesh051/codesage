...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'user_security_logs' 
    AND policyname = 'Users can view own security logs'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'code_submissions' 
    AND policyname = 'Users can manage own submissions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'code_analyses' 
    AND policyname = 'Users can manage own analyses'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'problem_solutions' 
    AND policyname = 'Users can manage own solutions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'code_submissions' 
    AND policyname = 'Admins can view all code submissions'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'code_analyses' 
    AND policyname = 'Admins can view all code analyses'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'problem_solutions' 
    AND policyname = 'Admins can view all problem solutions'
  ) THEN
...
DROP TRIGGER IF EXISTS update_problem_solutions_updated_at ON problem_solutions;
