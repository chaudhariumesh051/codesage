...
export const LandingPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description:
        "Advanced AI understands your code and provides intelligent insights with detailed explanations",
    ...
    },
    {
      ...
      description:
        "Get personalized video explanations with AI avatars that break down complex concepts",
    ...
    },
    {
      ...
      description:
        "Auto-generated interactive flowcharts that visualize your code logic and algorithm flow",
    ...
    },
    {
      ...
      description:
        "Personalized coding challenges based on your weak areas with real-time feedback",
    ...
    },
    {
      ...
      description:
        "24/7 AI assistant powered by Gemini 2.0 Flash for instant coding help and guidance",
    ...
    },
    {
      ...
      description:
        "Comprehensive analytics dashboard to track your coding journey and skill development",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "The personalized challenges helped me ace my coding interviews. Best investment I've made for my career!",
      avatar:
    ...
    },
    {
      ...
      content:
        "The AI assistant is like having a senior developer mentor available 24/7. Absolutely game-changing!",
      avatar:
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <section
        id="features"
        className="relative z-10 py-32 bg-gradient-to-b from-transparent to-slate-800/50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to master code understanding, debugging, and
              skill development
            </p>
          </motion.div>
