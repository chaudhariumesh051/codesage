/*
  # Chat History and Code Submissions Tables

  1. New Tables
    - `chat_history` - Store AI assistant conversations
...
DROP POLICY IF EXISTS "Users can manage their own code submissions" ON code_submissions;
